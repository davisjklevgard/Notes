...
public class DoubleEndedQueues {
    /*
        DE queue data Structure
            generally not used in real life programming because it is complex
            it allows for people to add and remove from the head and the tail of the queue
            so this allows you to add elements to the tail and the head
    ...
    */
    ...
    public static void main(String[] args)
    {
       ...
       DoubleEndedQueues dq = new DoubleEndedQueues(5);
